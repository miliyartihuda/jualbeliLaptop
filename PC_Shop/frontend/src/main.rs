            ...
            Msg::AddProduct => {
                ...
                self.link
                    .send_future(async move {
                        ...
                        let _response = add_product_to_backend(name, price, quantity).await;
                    });
                false
            }
            Msg::BuyProduct => {
        ...
        html! {
            <div>
                ...
                <div>
                    ...
                    <input type="number" placeholder="Harga Produk" oninput={ctx.link().callback(|e: InputData| Msg::SetNewPrice(e.value.parse().unwrap_or(0)))}/>
                    <input type="number" placeholder="Jumlah Produk" oninput={ctx.link().callback(|e: InputData| Msg::SetNewQuantity(e.value.parse().unwrap_or(0)))}/>
...
async fn add_product_to_backend(name: String, price: u64, quantity: u64) -> Result<(), String> {
